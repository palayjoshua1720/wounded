<template>
	<transition name="fade">
		<div v-if="modelValue" class="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto">
			...
			<div :class="['relative rounded-xl bg-white dark:bg-gray-800 shadow-xl border border-gray-200 dark:border-gray-700 mx-4 my-8', widthClass]" class="max-h-[90vh] w-full flex flex-col">
				...
				<div v-if="$slots.actions" class="border-t flex justify-end space-x-3">
					<slot name="actions" />
				</div>
			</div>
		</div>
