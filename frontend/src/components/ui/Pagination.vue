<template>
	<div class="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 px-3 sm:px-6 py-3 sm:py-4 bg-white dark:bg-gray-800 rounded-2xl sm:rounded-none border border-gray-100 dark:border-gray-700 sm:border-0 sm:border-t sm:border-gray-200 dark:sm:border-gray-700 shadow-sm sm:shadow-none">
