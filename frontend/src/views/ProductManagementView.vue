    ...
    <div class="space-y-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="space-y-2">
                ...
                <p class="text-gray-600 dark:text-gray-400 max-w-2xl">Manage products, their stock levels, and availability
            ...
            <div class="flex items-center gap-4">
                ...
                <button @click="openAddProductModal" class="flex items-center px-5 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-md hover:shadow-lg group">
                    <ListPlus class="w-5 h-5 mr-2 group-hover:scale-110 transition-transform" />
                    New Product
                </button>
            </div>
        ...
        <BaseModal v-model="showOtherProductModal" :title="isEditingOtherProduct ? 'Edit Other Product' : 'New Other Product'" size="xl">
            <form @submit.prevent="handleOtherProductSubmit" class="space-y-6">
                ...
                <select v-model="otherProductForm.brand_id" required
                    ...
                    <option value="1">Wound Supplies</option>
                ...
                <!-- Product Name -->
                    <div class="md:col-span-5">
                        ...
                        <input v-model="otherProductForm.name" type="text" required placeholder="e.g., Sterile Gloves, Wound Dressing Kit"
                    ...
                    <div class="md:col-span-4">
                        ...
                        <input v-model.number="otherProductForm.price" type="number" required min="0" step="0.01" placeholder="0.00"
                            class="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white" />
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-3">
                        ...
                        <input v-model.number="otherProductForm.stock" type="number" required min="0" placeholder="0"
                            class="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white" />
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea v-model="otherProductForm.description" rows="4" placeholder="Additional details about the product..." class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white resize-none"></textarea>
                </div>
        ...
        <BaseModal v-model="showAddProductModal" title="Add New Product">
            <div class="space-y-4">
                ...
                <button @click="selectGraftProduct"
                    ...
                    <PencilRuler class="w-12 h-12 text-green-600 dark:text-green-400 mb-4 group-hover:scale-110 transition-transform" />
                ...
                <button @click="selectOtherProduct"
                    ...
                    <Package class="w-12 h-12 text-blue-600 dark:text-blue-400 mb-4 group-hover:scale-110 transition-transform" />
...
import {
    ...
    ChevronDown, Factory, XCircle, AlertCircle, PackageCheck, CalendarPlus, PencilLine
...
async function handleOtherProductSubmit() {
  if (!otherProductForm.value.brand_id || !otherProductForm.value.name || otherProductForm.value.price <= 0) {
  ...
  try {
    ...
    // Example: await api.post('/management/other-products', otherProductForm.value)
    console.log('Submitting Other Product:', otherProductForm.value)
    toast.success(isEditingOtherProduct.value ? 'Product updated successfully!' : 'Product created successfully!')
    closeOtherProductForm()
    // Refresh table/stats when backend is connected
    // await getAllProducts() // Future combined product fetch
  } catch (error) {
