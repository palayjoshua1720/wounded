    ...
    <div class="space-y-8">
        ...
        <div v-if="showUsageLogForm"
            ...
            <UsageLogForm :inventory-items="inventory" :clinicians="clinicians" :brands="brands"
                @submit="handleUsageLogSubmitAndHide" @bulk-upload="handleBulkUpload"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-semibold text-gray-900 dark:text-white">{{
                                            item.productName || 'N/A' }}</div>
                                        <div class="text-sm text-gray-500 dark:text-gray-400">{{
                                            getBrandName(item.brandId) }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-5 whitespace-nowrap">
        ...
        <BaseModal v-model="showUploadModal" title="Upload Log Usage" width="max-w-2xl">
            <div class="space-y-6">
                ...
                <div
                    ...
                    <input type="file" accept=".pdf,.csv,.xlsx,.xls" class="hidden" id="file-upload" />
                ...
                <div class="bg-gray-50 dark:bg-gray-700/30 rounded-xl p-4 border border-gray-200 dark:border-gray-600">
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <h4 class="text-sm font-semibold text-gray-900 dark:text-white mb-2">Supported File Formats
                            </h4>
        ...
        <BaseModal v-model="showItemModal" title="Inventory Item Details" width="max-w-4xl">
            <div v-if="selectedItem" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div
                        class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow duration-200">
                        ...
                        <div class="space-y-3">
                            ...
                            <div v-if="selectedItem.expiryDate">
                                ...
                                <span v-if="isExpiringSoon(selectedItem.expiryDate)"
                                    class="inline-flex items-center mt-1 px-2 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-200">
            ...
            <template #actions>
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700/50 dark:to-gray-700 px-6 py-5">
                    <div v-if="selectedItem && selectedItem.status !== 'used' && selectedItem.status !== 'expired' && selectedItem.status !== 'returned' && selectedItem.status !== 'reassigned' && selectedItem.status !== 'unused'"
                        class="space-y-4">
                        <h3 class="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wide mb-3">
                            Quick Actions</h3>
                        <div class="flex flex-wrap gap-3">
                            <button v-if="selectedItem && selectedItem.status === 'expected'"
                            ...
                            <button v-if="selectedItem && ['delivered', 'partially_used'].includes(selectedItem.status)"
                ...
                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <select v-model="editingItem.brandId"
                        ...
                        <div>
                            ...
                            <select v-model="editingItem.sizeId"
                                class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-all duration-200">
                                <option v-for="size in getAvailableSizes(editingItem.brandId)" :key="size.id"
                                    :value="size.id">
                                    {{ size.size }}
                                </option>
                            </select>
                        ...
                        <div>
                            ...
                            <input v-model="editingItem.orderId" type="text"
                                class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-all duration-200"
                ...
                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="md:col-span-2">
                            ...
                            <select v-model="editingItem.clinicId"
                                class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-all duration-200">
